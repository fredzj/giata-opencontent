...
--
-- Table structure for table `vendor_giata_images`
--

CREATE TABLE `vendor_giata_images` (
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp(),
  `id` mediumint(8) UNSIGNED NOT NULL,
  `giata_id` int(10) UNSIGNED NOT NULL,
  `motif_type` varchar(255) DEFAULT NULL,
  `last_update` timestamp NULL DEFAULT NULL,
  `is_hero_image` tinyint(1) DEFAULT NULL,
...
--
-- Indexes for table `vendor_giata_images`
--
ALTER TABLE `vendor_giata_images`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `vendor_giata_images`
--
ALTER TABLE `vendor_giata_images`
